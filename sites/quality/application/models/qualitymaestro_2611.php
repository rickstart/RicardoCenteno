...
class Qualitymaestro extends CI_Model {
    ...
    function offices()
     {
		...
		# Oficina arq
		$maestro['132103']=array(
			'franquicia'	=>	'Quality Arq',
			'direccion1'	=>	'Plaza Versalles 2',
			'direccion2'	=>	'Col. Las Arboledas, Atizapán De Zaragoza',
			'estado'	=>	'Estado De México',
			'cp'	=>	'C.P. 52957',
			'email'	=>	'nitzaromero@quality.com.mx',
			'tel1'	=>	'(55)4623-2690 ',
			'tel2'	=>	'',
			'zona'	=>	'Zaragoza',
			'logo'	=>	'/images/logos/logo_arq.png',
			'google' =>	'31757639-1',
			'web1' =>	'qualityarq.com.mx',
			'web2' =>	'qualityarq.mx',
			'banner' =>	'/images/banners/bannerhome.gif',
			'bannerlink' =>	'#',
			'bannerclase' =>	'banneranimado',
			'linkmembresias' =>	'http://qualityfranquicias.com.mx/membresias/',
			'emailcontacto'	=>	'nitzaromero@quality.com.mx',
			'emailintegrate' =>	'qualitymembresias@zootropostudio.com',
			'socio' =>	'0'
     	);
		...
		# Oficina castell
		$maestro['131927']=array(
			'franquicia'	=>	'Quality Castell',
			'direccion1'	=>	'Rt. Fuente Molinos No. 21',
			'direccion2'	=>	'Col. Rincón del Pedregal',
			'estado'	=>	'Tlalpan, México, D.F.',
			'cp'	=>	'C.P. 14120',
			'email'	=>	'infocastell@quality.com.mx',
			'tel1'	=>	'(55) 5616-7302',
			'tel2'	=>	'',
			'zona'	=>	'Pedregal, Tlalpan',
			'logo'	=>	'/images/logos/logo_castell.png',
			'google' => '31759524-1',
			'web1' =>	'qualitycastell.com.mx',
			'web2' =>	'qualitycastell.mx',
			'banner' =>	'/images/banners/bannerhome.gif',
			'bannerlink' =>	'#',
			'bannerclase' =>	'banneranimado',
			'linkmembresias' =>	'http://qualityfranquicias.com.mx/membresias/',
			'emailcontacto'	=>	'infocastell@quality.com.mx',
			'emailintegrate' =>	'qualitymembresias@zootropostudio.com',
			'socio' =>	'0'
		);
		...
		$maestro['129569']=array(
			...
			'direccion1'	=>	'Montecito 38, Piso 37, Oficina 33 WTC',
		...
		# Oficina triplea
		$maestro['131764']=array(
			'franquicia'   =>	'Quality Triple A',
			'direccion1'   =>	'Ciclamores',
			'direccion2'	=>	'Col. La Perla',
			'estado'	=>	'Nezahualcoyotl, Edo. de México',
			'cp'	=>	'C.P. 57820',
			'email'	=>	'infotriplea@quality.com.mx',
			'tel1'	=>	'(55)1552-4559',
			'tel2'	=>	'',
			'zona'	=>	'Nezahualcoyotl',
			'logo'	=>	'/images/logos/logo_triplea.png',
			'google' =>	'31759529-1',
			'web1' =>	'qualitytriplea.com.mx',
     		'web2' =>	'qualitytriplea.mx',
			'banner' =>	'/images/banners/bannerhome.gif',
			'bannerlink' =>	'#',
			'bannerclase' =>	'banneranimado',
			'linkmembresias' =>	'http://qualityfranquicias.com.mx/membresias/',
			'emailcontacto'	=>	'infotriplea@quality.com.mx',
			'emailintegrate' =>	'qualitymembresias@zootropostudio.com',
			'socio' =>	'0'
       );
  ...
  // -----------------------------------------------------------
		...
		switch ($_SERVER['HTTP_HOST']){
			case 'www.qualityarq.com.mx':
			case 'www.qualityarq.mx':
			case 'qualityarq.com.mx':
			case 'qualityarq.mx':
			case 'qualityarq.com':
										$site=$maestro['132103'];
										break;
		...
		switch ($_SERVER['HTTP_HOST']){
					case 'www.qualitycastell.com.mx':
					case 'www.qualitycastell.mx':
					case 'qualitycastell.com.mx':
					case 'qualitycastell.mx':
												$site=$maestro['131927'];
												break;
		}
		...
		switch ($_SERVER['HTTP_HOST']){
			case 'www.qualitytriplea.com.mx':
			case 'www.qualitytriplea.mx':
			case 'qualitytriplea.com.mx':
			case 'qualitytriplea.mx':
										$site=$maestro['131764'];
										break;
		}
		...
		$locations=array(
			'Distrito Federal'	=>	array(
										...
										'id'	=>	array(108084, 128243,131719, 131718 , 131679, 131927, 130134, 129266, 131202, 108222, 112558,128501,130424,130718,129569,131054,130412,127759,127048,130930,126355,129688,130099,130924,110968,129397,128844,131053,131055,126931)
									),
			...
			'Estado de Mexico'	=>	array(
										...
										'id'	=>	array(129639, 132103, 129264, 130950,129971,131764)
									),
			...
			'Queretaro'	=>	array(
										...
										'id'	=>	array(130543, 1273270, 1305433, 12732701, 1305434, 12732702)
									),
